#ifndef FVSAND_NOGPU_H
#define FVSAND_NOGPU_H

#include <cstdlib>
#include <cstring>

#define FVSAND_GPU_DEVICE
#define FVSAND_GPU_GLOBAL
#define FVSAND_GPU_HOST
#define FVSAND_GPU_HOST_DEVICE
