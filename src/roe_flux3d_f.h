...
void computeJacobian_f( real_f& ql1, real_f& ql2, real_f& ql3, real_f& ql4, real_f& ql5,
                      ...
                      int & faceID,
		      real_f *lmatout, real_f *rmatout, real_f scaling, int idx, int ncells, int f, int nNeighs)
{
 ...
 FOR2(i,5,j,5)
     {
	     int index0 = i*5+j;
             ...
             int index2 = nNeighs*index0 + f;
	     lmatout[index1] += (lmat[i][j]*scaling);
	     rmatout[index2] = (rmat[i][j]*scaling);
     }
 ...
 FOR2(i,5,j,5)
     {
       ...
       atomicAdd(lmatout+index1,lmat[i][j]*scaling);
#else
       lmatout[index1] += (lmat[i][j]*scaling);
#endif
     }
...
FVSAND_GPU_DEVICE
void computeJacobianOffDiag_f2( real_f& ql1, real_f& ql2, real_f& ql3, real_f& ql4, real_f& ql5,
                      real_f& qr1, real_f& qr2, real_f& qr3, real_f& qr4, real_f& qr5,
                      real_f& nxd, real_f& nyd, real_f& nzd,
                      int & faceID,
		      real_f *rmatout, real_f scaling, int f, int nNeighs)
{
...
//------------------------------------------------------------------------------
      ...
      uconl = ul*nx + vl*ny + wl*nz;
//------------------------------------------------------------------------------!
//-------> linearization of right primitive states <-------------------!
//------------------------------------------------------------------------------!
...
FVSAND_GPU_DEVICE
void computeResidualJacobian_f( real_d & f1, real_d & f2, real_d & f3, real_d & f4, real_d & f5,
			     real_d & ql1, real_d& ql2, real_d & ql3, real_d & ql4, real_d & ql5,
			     real_d & qr1, real_d& qr2, real_d & qr3, real_d & qr4, real_d & qr5,
			     real_d & dsx, real_d & dsy, real_d & dsz,
			     real_d & gx, real_d & gy, real_d & gz, int & faceID,
                             real_j *lmatout, real_j *rmatout, real_j scaling, int idx, int ncells, int f, int nNeighs)
{
  real_d  gm1=0.4;
  real_d eps,rlft,ulft,vlft,wlft,plft;
  real_d rlfti,rulft,rvlft,rwlft,uvwl,elft,hlft,clft;
  real_d rrht,urht,vrht,wrht,prht;
  ...
  real_j dro_dql[5],dro_dqr[5];
  real_j du_dql[5],du_dqr[5];
  real_j dv_dql[5],dv_dqr[5];
  real_j dw_dql[5],dw_dqr[5];
  real_j dp_dql[5],dp_dqr[5];
  real_j ducon_dql[5],ducon_dqr[5];
  real_j ddel1_dql[5],ddel1_dqr[5];
  real_j ddel2_dql[5],ddel2_dqr[5];
  
  real_j dq5_dql[5],dq5_dqr[5];
  real_j dh_dql[5],dh_dqr[5];
  real_j dfact_dql[5],dfact_dqr[5];
  real_j dA_dql[5],dA_dqr[5];
  real_j dB_dql[5],dB_dqr[5];
  real_j drobar_dql[5],dubar_dql[5],dvbar_dql[5],dwbar_dql[5];
  real_j drobar_dqr[5],dubar_dqr[5],dvbar_dqr[5],dwbar_dqr[5];
  real_j dhbar_dql[5],duconbar_dql[5],dcbar_dql[5];
  real_j dhbar_dqr[5],duconbar_dqr[5],dcbar_dqr[5];
  
  real_j deig1_dql[5],deig2_dql[5],deig3_dql[5];
  real_j deig1_dqr[5],deig2_dqr[5],deig3_dqr[5];
  real_j dterm1_dql[5],dterm1_dqr[5];
  real_j dterm2_dql[5],dterm2_dqr[5];
  real_j imat[5][5];
  
  real_j lmat[5][5],rmat[5][5];
  real_j lmat1[5][5],rmat1[5][5];
...
//------------------------------------------------------------------------------!
      ...
      dp_dqr[0] =  0.5*gm1*( urht*urht + vrht*vrht + wrht*wrht);
      dp_dqr[1] = -gm1*urht;
      dp_dqr[2] = -gm1*vrht;
      dp_dqr[3] = -gm1*wrht;
      dp_dqr[4] =  gm1;
      ...
      dh_dqr[0] = -(qr5 + prht)*dro_dqr[0]/rrht/rrht + (1.0/rrht)*(dq5_dqr[0] + dp_dqr[0]);
      dh_dqr[1] = -(qr5 + prht)*dro_dqr[1]/rrht/rrht + (1.0/rrht)*(dq5_dqr[1] + dp_dqr[1]);
      dh_dqr[2] = -(qr5 + prht)*dro_dqr[2]/rrht/rrht + (1.0/rrht)*(dq5_dqr[2] + dp_dqr[2]);
      dh_dqr[3] = -(qr5 + prht)*dro_dqr[3]/rrht/rrht + (1.0/rrht)*(dq5_dqr[3] + dp_dqr[3]);
      dh_dqr[4] = -(qr5 + prht)*dro_dqr[4]/rrht/rrht + (1.0/rrht)*(dq5_dqr[4] + dp_dqr[4]);

      ducon_dqr[0] = -uurht/rrht;
      ducon_dqr[1] =  r1   /rrht;
      ducon_dqr[2] =  r2   /rrht;
      ducon_dqr[3] =  r3   /rrht;
      ducon_dqr[4] =  0.0;
...
for( int i = 0; i < 5 ; i++ )
 {
      ...
      dfact_dqr[i] = (0.5/rat)*(1.0/rlft)*dro_dqr[i];

      dA_dql[i] = -dfact_dql[i]/(1.0+rat)/(1.0+rat);
      dA_dqr[i] = -dfact_dqr[i]/(1.0+rat)/(1.0+rat);

      dB_dql[i] = dfact_dql[i]/(1.0 + rat)/(1.0 + rat);
      dB_dqr[i] = dfact_dqr[i]/(1.0 + rat)/(1.0 + rat);

      drobar_dql[i] = dro_dql[i]*rat + rlft*dfact_dql[i];
      drobar_dqr[i] =                   rlft*dfact_dqr[i];

      dubar_dql[i] = du_dql[i]*rati + ulft*dA_dql[i]               + urht*dB_dql[i];
      dubar_dqr[i] =               ulft*dA_dqr[i] + du_dqr[i]*rat*rati + urht*dB_dqr[i];

      dvbar_dql[i] = dv_dql[i]*rati + vlft*dA_dql[i]               + vrht*dB_dql[i];
      dvbar_dqr[i] =               vlft*dA_dqr[i] + dv_dqr[i]*rat*rati + vrht*dB_dqr[i];

      dwbar_dql[i] = dw_dql[i]*rati + wlft*dA_dql[i]               + wrht*dB_dql[i];
      dwbar_dqr[i] =               wlft*dA_dqr[i] + dw_dqr[i]*rat*rati + wrht*dB_dqr[i];

      dhbar_dql[i] = dh_dql[i]*rati + hlft*dA_dql[i]               + hrht*dB_dql[i];
      dhbar_dqr[i] =               hlft*dA_dqr[i] + dh_dqr[i]*rat*rati + hrht*dB_dqr[i];
      ...
      dcbar_dqr[i] = gm1*( dhbar_dqr[i] - uav*dubar_dqr[i]     
                                        - vav*dvbar_dqr[i]     
                                        - wav*dwbar_dqr[i] );
      dcbar_dqr[i] = dcbar_dqr[i]*0.5/cav ;

      duconbar_dql[i] = dubar_dql[i]*r1 + dvbar_dql[i]*r2 + dwbar_dql[i]*r3;
      duconbar_dqr[i] = dubar_dqr[i]*r1 + dvbar_dqr[i]*r2 + dwbar_dqr[i]*r3;
      ...
      ddel1_dqr[i] = dterm1_dqr[i]*aq5/cav/cav + term1*dp_dqr[i]/cav/cav - 2.0*term1*aq5*dcbar_dqr[i]/cav/cav/cav;
      ddel1_dqr[i] = ddel1_dqr[i] + dterm2_dqr[i]*rav*( uurht-uulft )/cav + term2*drobar_dqr[i]*(uurht-uulft)/cav 
                                  + term2*rav*ducon_dqr[i]/cav - dcbar_dqr[i]*term2*rav*(uurht-uulft)/cav/cav;
      ...
      ddel2_dqr[i] = dterm1_dqr[i]*(uurht-uulft)*rav + term1*ducon_dqr[i]*rav + term1*(uurht-uulft)*drobar_dqr[i];
      ddel2_dqr[i] = ddel2_dqr[i] + dterm2_dqr[i]*aq5/cav + term2*dp_dqr[i]/cav - dcbar_dqr[i]*term2*aq5/cav/cav;
}
	...
	aumc = aumc*aumc/daumc+0.25*daumc;
      ...
      FOR2(i,5,j,5)
       {      
         ...
         rmat[i][j] = rmat[i][j] + auu*imat[i][j];       
       }
      ...
      for ( int i = 0 ; i < 5 ; i++ )
      {
       ...
       rmat[1][i] = rmat[1][i] + ddel1_dqr[i]*uav + ddel2_dqr[i]*r1;

       lmat[2][i] = lmat[2][i] + ddel1_dql[i]*vav + ddel2_dql[i]*r2;
       rmat[2][i] = rmat[2][i] + ddel1_dqr[i]*vav + ddel2_dqr[i]*r2;

       lmat[3][i] = lmat[3][i] + ddel1_dql[i]*wav + ddel2_dql[i]*r3;
       rmat[3][i] = rmat[3][i] + ddel1_dqr[i]*wav + ddel2_dqr[i]*r3;

       lmat[4][i] = lmat[4][i] + ddel1_dql[i]*hav + ddel2_dql[i]*uu;
       rmat[4][i] = rmat[4][i] + ddel1_dqr[i]*hav + ddel2_dqr[i]*uu;
       }
...
//      !-----> right state
      ...
      rmat1[0][j] = dro_dqr[j]*uurht + rrht*ducon_dqr[j];

      rmat1[1][j] = dro_dqr[j]*uurht*urht + rrht*ducon_dqr[j]*urht + rrht*uurht*du_dqr[j];
      rmat1[2][j] = dro_dqr[j]*uurht*vrht + rrht*ducon_dqr[j]*vrht + rrht*uurht*dv_dqr[j];
      rmat1[3][j] = dro_dqr[j]*uurht*wrht + rrht*ducon_dqr[j]*wrht + rrht*uurht*dw_dqr[j];

      rmat1[2][j] = rmat1[2][j] + r2*dp_dqr[j];
      rmat1[1][j] = rmat1[1][j] + r1*dp_dqr[j];
      rmat1[3][j] = rmat1[3][j] + r3*dp_dqr[j];

      rmat1[4][j] = ( dq5_dqr[j] + dp_dqr[j] )*uurht + (qr5 + prht)*ducon_dqr[j];
...
//      !======================================================================
     FOR2(i,5,j,5)
     {
       ...
       rmat[i][j] = 0.5*( rmat1[i][j] - rmat[i][j] )*rr;
     }
 }  
 FOR2(i,5,j,5)
     {
...
FVSAND_GPU_DEVICE
void computeResidualJacobianDiag_f( real_d & f1, real_d & f2, real_d & f3, real_d & f4, real_d & f5,
			     real_d & ql1, real_d& ql2, real_d & ql3, real_d & ql4, real_d & ql5,
			     real_d & qr1, real_d& qr2, real_d & qr3, real_d & qr4, real_d & qr5,
			     real_d & dsx, real_d & dsy, real_d & dsz,
			     real_d & gx, real_d & gy, real_d & gz, int & faceID,
                             real_j *lmatout, real_j scaling, int idx, int ncells)
{
  real_d  gm1=0.4;
  real_d eps,rlft,ulft,vlft,wlft,plft;
  real_d rlfti,rulft,rvlft,rwlft,uvwl,elft,hlft,clft;
...
FVSAND_GPU_DEVICE
void computeResidualJacobianDiag_f2( real_d & f1, real_d & f2, real_d & f3, real_d & f4, real_d & f5,
			     real_d & ql1, real_d& ql2, real_d & ql3, real_d & ql4, real_d & ql5,
			     real_d & qr1, real_d& qr2, real_d & qr3, real_d & qr4, real_d & qr5,
			     real_d & dsx, real_d & dsy, real_d & dsz,
			     real_d & gx, real_d & gy, real_d & gz, int & faceID,
                             real_j *lmatout, real_j scaling1, real_j scaling2, int idx, int idxn, int ncells)
{
  real_d  gm1=0.4;
  real_d eps,rlft,ulft,vlft,wlft,plft;
  real_d rlfti,rulft,rvlft,rwlft,uvwl,elft,hlft,clft;
 ...
 FOR2(i,5,j,5)
     {
	     int index0 = i*5+j;
             int index1 = ncells*index0 + idx;
             int index2 = ncells*index0 + idxn;
#if defined (FVSAND_HAS_GPU)
             atomicAdd(lmatout+index1,lmat[i][j]*scaling1);
             if (idxn > -1 && idxn < ncells) atomicAdd(lmatout+index2,-rmat[i][j]*scaling2);
#else
             lmatout[index1] += (lmat[i][j]*scaling1);
	     if (idxn > -1 && idxn < ncells) lmatout[index2] -= (rmat[i][j]*scaling2);
#endif
     }
}
